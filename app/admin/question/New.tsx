  ...
  return (
    <div className="p-8">
      <h1 className="text-2xl font-bold mb-6">
        {roundMode ? "New Round" : "Round Details"}
      </h1>
          ...
          >
            ...
            >
              ...
              {topics.map((topic) => {
                ...
                if (Number(subject?.id) !== Number(selectedSubject))
                  return null; // Filter topics based on selected subject
