  ...
  return (
    <div>
      ...
      <div className="flex justify-center gap-2 mx-2 my-2 mt-3">
        <div className="text-center w-6 h-6 bg-green-500 rounded-full">1</div>
        <div className="text-center w-6 h-6 bg-red-500 rounded-full">2</div>
        <div className="text-center w-6 h-6 border rounded-full ">3</div>
        <div className="text-center w-6 h-6 border rounded-full ">5</div>
        <div className="text-center w-6 h-6 border rounded-full ">6</div>
        <div className="text-center w-6 h-6 border rounded-full ">7</div>
        <div className="text-center w-6 h-6 border rounded-full ">8</div>
        <div className="text-center w-6 h-6 border rounded-full ">9</div>
        <div className="text-center w-6 h-6 border rounded-full ">10</div>
      </div>
      <div className="border p-2 m-5 rounded-lg ">
        {/* questions div */}
        <div>
